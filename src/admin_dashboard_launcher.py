...
def check_requirements():
    ...
    required_packages = [
        'flask', 'werkzeug', 'sqlite3', 'pandas', 'openpyxl', 'reportlab', 
        'matplotlib', 'dotenv', 'schedule', 'requests', 'bs4', 'langchain',
        'faiss-cpu', 'cohere', 'anthropic', 'openai', 'google-generativeai',
        'mistralai', 'xlsxwriter'
    ]
...
def create_directories():
    ...
    from src.chatbot.utils.paths import (
        DATA_DIR, WEB_CONTENT_DIR, INDEXES_DIR, DATABASE_DIR, LOGS_DIR
    )
...
def main():
    ...
    print(f"Starting RAG Admin Dashboard on http://{'localhost' if args.host == '0.0.0.0' else args.host}:{args.port}")
