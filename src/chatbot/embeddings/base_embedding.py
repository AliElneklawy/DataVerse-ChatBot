...
class CohereEmbedding(BaseEmbedding):
    def __init__(self, api_key, embedding_model: str = "embed-multilingual-v3.0"):
...
class MistralEmbedding(BaseEmbedding):
    def __init__(self, api_key, embedding_model: str = "mistral-embed"):
    ...
    def embed(self, texts, _):
        ...
        response = self.client.embeddings.create(
            inputs=texts, model=self.embedding_model
        )
